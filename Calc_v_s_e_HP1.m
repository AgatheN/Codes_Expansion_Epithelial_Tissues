...
function [V,S,E_point]=Calc_v_s_e_HP1(T,Xi,n,f,initial_delta_x,av_nb_of_nodes,av_nb_of_cells,k,typical_surf)
...
for t=1:size(T)
  ...
  for i = 2:av_nb_of_nodes-1
      V(t,i)=(-k*((Xi(t,i)-Xi(t,i-1)-initial_delta_x)/initial_delta_x)+k*((Xi(t,i+1)-Xi(t,i)-initial_delta_x)/initial_delta_x))/n;
